Lights1 onion_Material_001_f3d_lights = gdSPDefLights1(
	0x76, 0x77, 0x63,
	0xEC, 0xEE, 0xC7, 0x28, 0x28, 0x28);

Vtx onion_Cube_mesh_vtx_0[40] = {
...
Gfx onion_Cube_mesh_tri_0[] = {
	gsSPVertex(onion_Cube_mesh_vtx_0 + 0, 16, 0),
	...
	gsSPVertex(onion_Cube_mesh_vtx_0 + 16, 16, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	...
	gsSP1Triangle(12, 13, 14, 0),
	gsSP1Triangle(12, 14, 15, 0),
	gsSPVertex(onion_Cube_mesh_vtx_0 + 32, 8, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSP1Triangle(4, 5, 6, 0),
	gsSP1Triangle(4, 6, 7, 0),
...
Gfx mat_onion_Material_001_f3d[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT, 0, 0, 0, SHADE, 0, 0, 0, ENVIRONMENT),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsSPSetLights1(onion_Material_001_f3d_lights),
	gsSPEndDisplayList(),
};


Gfx onion_Cube_mesh[] = {
	gsSPDisplayList(mat_onion_Material_001_f3d),
	gsSPDisplayList(onion_Cube_mesh_tri_0),
	gsDPPipeSync(),
